    ...
    <section className="rt-hero-contact">
      <div className="rt-container">
        <div className="rt-hero-contact-content">
          ...
          <p>I’m super easy to reach.<br /><br />If you’d like to connect on anything related to career growth, code, design, or writing, please feel free to get in touch. You can <a className="text-link-dark" href="mailto:makertolentino@gmail.com" target="_blank" rel="noopener noreferrer">send a message</a> or find me on the socials.</p>
